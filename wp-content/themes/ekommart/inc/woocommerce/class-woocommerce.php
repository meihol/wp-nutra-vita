    ...
    class Ekommart_WooCommerce {
        ...
        public function __construct() {
            ...
            add_filter('woocommerce_single_product_image_gallery_classes', function ($wrapper_classes) {
                $wrapper_classes[] = 'woocommerce-product-gallery-' . ekommart_get_theme_option('single_product_gallery_layout', 'horizontal');
        ...
        public function woocommerce_body_class($classes) {
            ...
            if (is_product()) {
                $classes[] = 'ekommart-full-width-content';
                $classes[] = 'single-product-' . ekommart_get_theme_option('single_product_gallery_layout', 'horizontal');
        ...
        public function thumbnail_columns() {
            ...
            if (ekommart_get_theme_option('single_product_gallery_layout', 'horizontal') == 'vertical') {
                $columns = 1;
            }
