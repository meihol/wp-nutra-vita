<?php
/**
 * Ekommart WooCommerce Adjacent Products Class
 *
 * @package  ekommart
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Ekommart_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Ekommart WooCommerce Adjacent Products Class
	 */
	class Ekommart_WooCommerce_Adjacent_Products {
